...
func DefaultConfig() *Config {
	...
	cfg.Consensus.TimeoutPropose = 100 * time.Second
	cfg.Consensus.TimeoutProposeDelta = 50000 * time.Millisecond
	cfg.Consensus.TimeoutPrevote = 100 * time.Second
	cfg.Consensus.TimeoutPrevoteDelta = 5000 * time.Millisecond
	cfg.Consensus.TimeoutPrecommit = 100 * time.Second
	cfg.Consensus.TimeoutPrecommitDelta = 5000 * time.Millisecond
	cfg.Consensus.TimeoutCommit = 100 * time.Second
