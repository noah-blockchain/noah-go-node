...
var unmarshalBytesTests = []unmarshalTest{
	...
	{input: `"NOAHx0"`, wantErr: wrapTypeError(ErrOddLength, bytesT)},
	{input: `"NOAHxxx"`, wantErr: wrapTypeError(ErrSyntax, bytesT)},
	{input: `"NOAHx01zz01"`, wantErr: wrapTypeError(ErrSyntax, bytesT)},

	// valid encoding
	{input: `""`, want: referenceBytes("")},
	{input: `"NOAHx"`, want: referenceBytes("")},
	{input: `"NOAHx02"`, want: referenceBytes("02")},
	{input: `"NOAHX02"`, want: referenceBytes("02")},
	{input: `"NOAHxffffffffff"`, want: referenceBytes("ffffffffff")},
	{
		input: `"NOAHxffffffffffffffffffffffffffffffffffff"`,
...
func BenchmarkUnmarshalBytes(b *testing.B) {
	input := []byte(`"NOAHx123456789abcdef123456789abcdef"`)
	for i := 0; i < b.N; i++ {
		var v Bytes
