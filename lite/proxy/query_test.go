...
import (
	...
	client2 "github.com/noah-blockchain/noah-go-node/lite/client"
	"os"
	"testing"
	"time"
	...
	"github.com/noah-blockchain/noah-go-node/abci/example/kvstore"
	nm "github.com/noah-blockchain/noah-go-node/node"
...
func _TestAppProofs(t *testing.T) {
	...
	source := client2.NewProvider(chainID, cl)
