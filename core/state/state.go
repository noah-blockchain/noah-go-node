...
import (
	...
	legacyAccounts "github.com/noah-blockchain/noah-go-node/legacy/accounts"
	legacyApp "github.com/noah-blockchain/noah-go-node/legacy/app"
	legacyCandidates "github.com/noah-blockchain/noah-go-node/legacy/candidates"
	legacyCoins "github.com/noah-blockchain/noah-go-node/legacy/coins"
	legacyFrozenfunds "github.com/noah-blockchain/noah-go-node/legacy/frozenfunds"
...
func (s *State) Import(state types.AppState) error {
	...
	for _, c := range state.Candidates {
		...
		s.Candidates.SetTotalStake(c.PubKey, helpers.StringToBigInt(c.TotalNoahStake))
