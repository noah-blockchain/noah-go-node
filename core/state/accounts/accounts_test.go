...
func TestAccounts_Export(t *testing.T) {
	...
	if string(bytes) != "[{\"address\":\"NOAHx0400000000000000000000000000000000000000\",\"balance\":[{\"coin\":1,\"value\":\"1001\"},{\"coin\":0,\"value\":\"1000\"}],\"nonce\":0,\"multisig_data\":{\"weights\":[1,1,2],\"threshold\":2,\"addresses\":[\"NOAHx0100000000000000000000000000000000000000\",\"NOAHx0200000000000000000000000000000000000000\",\"NOAHx0300000000000000000000000000000000000000\"]}}]" {
