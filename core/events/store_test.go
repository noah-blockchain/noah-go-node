...
func TestIEventsDB(t *testing.T) {
...

	{
		...
		bytesAddress, err := hex.DecodeString("NOAHx04bea23efb744dc93b4fda4c20bf4a21c6e195f1"[2:])
		if err != nil {
			t.Fatal(err)
		}
	...
	}
	{
		...
		bytesAddress, err := hex.DecodeString("NOAHx18467bbb64a8edf890201d526c35957d82be3d95"[2:])
		if err != nil {
			t.Fatal(err)
		}
		copy(event.Address[:], bytesAddress)
