...
func createTestCoin(stateDB *state.State) {
	volume := helpers.NoahToQNoah(big.NewInt(100000))
	reserve := helpers.NoahToQNoah(big.NewInt(100000))
...
func TestBuyCoinTxInsufficientFunds(t *testing.T) {
	...
	cState.Accounts.AddBalance(addr, coin, helpers.NoahToQNoah(big.NewInt(1)))
...
func TestBuyCoinTxNotGasCoin(t *testing.T) {
	...
	cState.Accounts.AddBalance(addr, getTestCoinSymbol(), helpers.NoahToQNoah(big.NewInt(1000)))
...
func TestBuyCoinTxCustomToBase(t *testing.T) {
	...
	cState.Accounts.AddBalance(addr, coin, helpers.NoahToQNoah(big.NewInt(10000000)))
...
func TestBuyCoinReserveUnderflow(t *testing.T) {
	...
	toBuy := helpers.NoahToQNoah(big.NewInt(99000))
...
func TestBuyCoinTxBaseToCustomBaseCommission(t *testing.T) {
	...
	toBuy := helpers.NoahToQNoah(big.NewInt(100))
