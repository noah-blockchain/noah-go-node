...
import (
	...
	"github.com/noah-blockchain/minoahnter-go-node/config"
...
func NewManager(blockchain *noah.Blockchain, tmRPC *rpc.Local, cfg *config.Config) pb.ManagerServiceServer {
