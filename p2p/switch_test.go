...
type TestReactor struct {
	...
	mtx          sync.Mutex
	channels     []*conn2.ChannelDescriptor
	logMessages  bool
	msgsCounter  int
	msgsReceived map[byte][]PeerMessage
}

func NewTestReactor(channels []*conn2.ChannelDescriptor, logMessages bool) *TestReactor {
	tr := &TestReactor{
		channels:     channels,
...
func (tr *TestReactor) GetChannels() []*conn2.ChannelDescriptor {
	return tr.channels
}
...
func initSwitchFunc(i int, sw *Switch) *Switch {
	...
	sw.AddReactor("foo", NewTestReactor([]*conn2.ChannelDescriptor{
		{ID: byte(0x00), Priority: 10},
		{ID: byte(0x01), Priority: 10},
	}, true))
	sw.AddReactor("bar", NewTestReactor([]*conn2.ChannelDescriptor{
